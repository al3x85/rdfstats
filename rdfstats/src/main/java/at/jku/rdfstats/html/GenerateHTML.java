...
public class GenerateHTML {
	...
	public static String generateHTML(RDFStatsModel s, String sourceUrl) throws RDFStatsModelException {
		...
		if (sourceUrl != null)
			datasets.add(s.getDataset(sourceUrl)); // just one
		else
	...
	private static void appendHistogram(StringBuilder sb, Histogram h, String range) {
		...
		if (range != null)
			sb.append("<strong>Range:</strong> &lt;").append(range).append("&gt;");
		
		sb.append("</td>\n")
		.append("</tr>\n")
		.append("<tr class=\"barvrow\">\n");
		
		for (int l : bins)
			sb.append("<td style=\"border-bottom-width: ").append((int) (l*histogramHeight / (float) maxQuant)).append("px\"").append(">").append(l).append("</td>\n");
		...
		if (h instanceof OrderedStringHistogram) { 
			...
			sb.append("</tr>\n");
			sb.append("<tr><td colspan=\"").append(bins.length).append("\">distinct values per bin:</td></tr>\n");
			sb.append("<tr class=\"bartrow\">\n");
		...
		sb.append("</table>\n")
		.append("<table class=\"chart\">\n")
		.append("<tr><td><strong>Total values:</strong> ").append(h.getTotalValues()).append(" (").append(h.getDistinctValues()).append(" distinct values)</td></tr>\n");
		...
		if (h instanceof OrderedStringHistogram) {
			sb.append("<tr>\n")
			.append("<td><strong>StringOrderedHistogram:</strong> move the cursor over the bin index to view the corresponding string prefix label.</td>\n")
			.append("</tr>\n");
		}
