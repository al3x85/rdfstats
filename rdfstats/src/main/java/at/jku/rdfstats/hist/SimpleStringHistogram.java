...
public class SimpleStringHistogram extends AbstractHistogram<String> {
	 ...
	 * @param max
	 */
	public SimpleStringHistogram(String typeUri, int[] bins, String[] labels, Class<? extends HistogramBuilder<?>> builderClass) {
		super(typeUri, bins, bins.length, builderClass);
