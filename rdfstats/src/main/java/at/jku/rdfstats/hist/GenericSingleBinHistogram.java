...
public class GenericSingleBinHistogram extends AbstractHistogram<Object> {
	...
	public GenericSingleBinHistogram(String typeUri, int total, int distinct, Class<? extends HistogramBuilder<?>> builderClass) {
		super(typeUri, new int[] { total }, distinct, builderClass);
	}
