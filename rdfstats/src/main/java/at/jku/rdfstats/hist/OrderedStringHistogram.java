...
public class OrderedStringHistogram extends AbstractComparableDomainHistogram<String> {
	 ...
	 * @param bins
	 */
	public OrderedStringHistogram(String typeUri, int[] bins, int distinctValues, int[] distinctBinValues, String[] labels, String min, String max, Class<? extends HistogramBuilder<?>> builderClass) {
		super(typeUri, bins, distinctValues, min, max, builderClass);
