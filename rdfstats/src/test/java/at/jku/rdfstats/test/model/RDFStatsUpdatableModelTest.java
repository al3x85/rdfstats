...
//	}
	...
	public void testAddOrReplaceHistogram() throws RDFStatsModelException, HistogramBuilderException {
		...
		IntegerHistogram h1 = new IntegerHistogram(XSDDatatype.XSDint.getURI(), new int[] {3, 0, 10, 0, 1}, 14, 0, 10, IntegerHistogramBuilder.class);
		IntegerHistogram h2 = new IntegerHistogram(XSDDatatype.XSDint.getURI(), new int[] {1, 3, 1, 10, 0}, 10, -23, 10, IntegerHistogramBuilder.class);
		IntegerHistogram h3 = new IntegerHistogram(XSDDatatype.XSDint.getURI(), new int[] {34, 3, 1, 130, 10}, 148, -44, 130, IntegerHistogramBuilder.class);
